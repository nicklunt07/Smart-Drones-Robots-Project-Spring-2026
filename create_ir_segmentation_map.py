...
def radiance(absoluteTemperature, emissivity, dx=0.01, response=None):
    ...
    if absoluteTemperature.ndim > 1:
        return radiance, numpy.trapezoid(radiance, dx=dx, axis=1)
    else:
        return radiance, numpy.trapezoid(radiance, dx=dx)
...
if __name__ == '__main__':
    ...
    # segIdDict = {
    #             "StaticMeshActor_UAID_D8BBC15DC129E9D102_1500297207": "human",
    #             "Landscape": "soil",
    #             }
    
    segIdDict = {
        "SkeletalMeshActor_UAID_D8BBC15DC129D9D702_1232402727": "dog",   # leave these or remove, see note
        "SkeletalMeshActor_UAID_D8BBC15DC129D9D702_1235605728": "cat",
        "Plant":       "Plant",
        "grass":       "grass",
        "Landscape":   "Landscape",
        "road":        "road",
